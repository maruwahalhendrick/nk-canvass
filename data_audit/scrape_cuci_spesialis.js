// Phase 1: niche CUCI BARANG SPESIALIS (sofa/kasur/karpet + tas/helm)
// Output: cuci_spesialis_candidates.json
...
const OUT = '/home/marwhal/nk-canvass/data_audit/cuci_spesialis_candidates.json';

const PLAN = [
  { category: 'Cuci Sofa & Karpet', queries: [
    'cuci sofa sukabumi',
    'cuci kasur sukabumi',
    'cuci karpet sukabumi',
    'cuci spring bed sukabumi',
    'laundry sofa sukabumi',
  ]},
  { category: 'Cuci Tas & Helm', queries: [
    'cuci tas sukabumi',
    'laundry tas sukabumi',
    'cuci helm sukabumi',
    'laundry helm sukabumi',
  ]},
];
