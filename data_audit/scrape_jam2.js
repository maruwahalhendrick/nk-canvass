// Phase 1 round 2: variasi query toko jam (kios, penjual, perbaikan, smartwatch, second, kabupaten)
// Output: jam_candidates2.json
...
const OUT = '/home/marwhal/nk-canvass/data_audit/jam_candidates2.json';

const PLAN = [
  { category: 'Retail', queries: [
    'kios jam sukabumi',
    'penjual jam tangan sukabumi',
    'perbaikan jam sukabumi',
    'servis arloji sukabumi',
    'jam smartwatch sukabumi',
    'apple watch sukabumi',
    'toko jam second sukabumi',
    'toko jam cibadak',
    'toko jam cisaat',
    'toko jam cicurug',
  ]},
