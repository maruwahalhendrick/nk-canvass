// Phase 1: scrape Maps query niche GAMING (rental PS/game center/toko game), list mode
// Output: gaming_candidates.json
...
const OUT = '/home/marwhal/nk-canvass/data_audit/gaming_candidates.json';

const PLAN = [
  { category: 'Gaming', queries: [
    'rental ps sukabumi',
    'rental playstation sukabumi',
    'game center sukabumi',
    'toko kaset game ps sukabumi',
    'gaming lounge esports sukabumi',
    'rental ps5 sukabumi',
  ]},
];
      ...
      try {
        ...
        const data = await page.evaluate(() => {
          ...
          feed.querySelectorAll(':scope > div').forEach(b => {
            ...
            const name = t.slice(0, ri).reverse().find(l => !/^(Tempat|Jasa|Toko|Apotek|Bengkel|Kedai|Layanan|Klinik|Restoran|Pemasok|Dealer|Kantor|Cabang|Agent|Agen|Rental)/.test(l) && l.length > 2) || t[0];
