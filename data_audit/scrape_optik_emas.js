// Phase 1: niche OPTIK & TOKO EMAS (gabungan 2 grup kategori)
// Output: optik_emas_candidates.json
...
const OUT = '/home/marwhal/nk-canvass/data_audit/optik_emas_candidates.json';

const PLAN = [
  { category: 'Optik & Kacamata', queries: [
    'optik sukabumi',
    'toko kacamata sukabumi',
    'optic center sukabumi',
    'ganti lensa kacamata sukabumi',
    'optik cicurug',
    'optik cibadak',
  ]},
  { category: 'Toko Emas & Perhiasan', queries: [
    'toko emas sukabumi',
    'jual emas sukabumi',
    'perhiasan emas sukabumi',
    'toko emas cicurug',
    'toko emas cibadak',
    'toko emas cisaat',
  ]},
