// Phase 1: scrape Maps niche FOTO & KAMERA (sewa kamera, toko kamera, photographer, cetak foto)
// Output: kamera_candidates.json
...
const OUT = '/home/marwhal/nk-canvass/data_audit/kamera_candidates.json';

const PLAN = [
  { category: 'Foto & Kamera', queries: [
    'sewa kamera sukabumi',
    'toko kamera sukabumi',
    'jasa photographer sukabumi',
    'foto wedding sukabumi',
    'cetak foto sukabumi',
    'rental lensa kamera sukabumi',
  ]},
];
