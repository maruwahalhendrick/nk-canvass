// Phase 1: scrape Maps niche HP/IPHONE spesifik (service iPhone, toko iPhone, kredit HP, counter)
// Output: hp_candidates.json
...
const OUT = '/home/marwhal/nk-canvass/data_audit/hp_candidates.json';

const PLAN = [
  { category: 'Electronics', queries: [
    'kredit hp sukabumi',
    'service iphone sukabumi',
    'jual iphone sukabumi',
    'counter hp sukabumi',
  ]},
];
